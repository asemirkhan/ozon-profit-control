...
DROP TABLE IF EXISTS client_demo.mart_executive_summary_30d;

WITH leak AS (
  SELECT *
  FROM client_demo.mart_leakage_summary_30d
  WHERE period_start = '2026-02-01'::date
    AND period_end   = '2026-03-01'::date
),
top_profit AS (
  SELECT offer_id, profit_after_ads
  FROM client_demo.mart_pnl_30d_by_product
  WHERE period_start = '2026-02-01'::date
    AND period_end   = '2026-03-01'::date
...
INTO client_demo.mart_executive_summary_30d
FROM leak
